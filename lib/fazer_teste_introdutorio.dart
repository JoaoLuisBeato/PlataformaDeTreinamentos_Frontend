...
class FazerTesteIntrodutorioCall extends StatefulWidget {
  ...
  const FazerTesteIntrodutorioCall({required this.randId, required this.emailUser});

  @override
  FazerTesteIntrodutorio createState() => FazerTesteIntrodutorio();
}

class FazerTesteIntrodutorio extends State<FazerTesteIntrodutorioCall> {
  int randId = 0;
  String emailUser = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Fazer teste do curso introdutório'),
      ...
      body: Padding(
          ...
          child: Column(
            children: [
              Center(
                child: Text('Teste Curso Introdutório', style: styleMainTitle),
              ),
              Expanded(
                child: ListView.builder(
                  itemCount: dataListCase1.length,
                  itemBuilder: (context, index) {
                    return Column(
                      children: [
                        ...
                        returnAnswers(
                            index, dataListCase1, dataListRespostas),
                        const Padding(
